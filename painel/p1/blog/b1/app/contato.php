...
<div class="container">
	...
	<div class="conteudo">
		<div class="contato">
			<div class="text-info-contato" >
				<span>Entre em contato</span>
				<p>Use o formulário abaixo para entrar em contato com agente! :) </p>
				<br />
				<div id="msg">
					<p><?php
			...
			<div class="form">
				<form action="app/sql/sql-contato.php" method="post">
					<input name="nome" type="text" placeholder="Seu Nome" ><br />
					<input name="email" type="email" placeholder="Email..." ><br />
					<textarea name="msg" placeholder="Sua Mensagem..." ></textarea><br />
